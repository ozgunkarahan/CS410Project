...
class TuringStates{
    ...
    public TuringStates(String x){
        ...
        TMState = project3.StringDivider(x," ");
...
public class project3 {
    ...
    private static final String path="TM3.txt";  /** FILE NAME GOES HERE COMMENTED LINES
    ...
    public static BufferedReader FileReader() {
        URL path2= project3.class.getResource(path);
...
//
//                }
                else if (starting.loopCount>100) {
                    AccOrRej="Looped";
                    break;
